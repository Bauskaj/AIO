...
VALIDITY () {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/SETANTAZVPN/ip/main/ip | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://github.com/SETANTAZVPN/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
# validity
rm -f /usr/bin/e
valid=$(curl https://github.com/SETANTAZVPN/ip | grep $MYIP | awk '{print $4}')
...
today=`date -d "0 days" +"%Y-%m-%d"`
Exp1=$(curl https://github.com/SETANTAZVPN/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Bauskaj/AIO/main/"
...
domain=$(cat /etc/xray/domain)
    ...
    CHATID="6425014714"
    KEY="6094210408:AAHx2ZMJ8PbcR4SjKvH1n-qDEGm0HoiAIWY"
    TIME="10"
    URL="https://api.telegram.org/bot$KEY/sendMessage"
    TEXT="
       𝗦𝘂𝗰𝗰𝗲𝘀 𝗮𝘁 𝗥𝗲𝗴𝗶𝘀𝘁𝗿𝘆 𝗩𝗣𝗦 𝗜𝗡𝗙𝗢
◇━━━━━━━━━━━━━━━━━━━━━━━◇
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    wget -O /etc/systemd/system/runn.service "${REPO3}xray/runn.service" >/dev/null 2>&1
...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/rizyulstore/xva/main/backup/rclone.conf"
...
wget -q -O /etc/ipserver "https://raw.githubusercontent.com/rizyulstore/xva/main/ssh/ipserver" && bash /etc/ipserver
...
wget https://raw.githubusercontent.com/Bauskaj/AIO/main/menu.zip
unzip menu.zip
chmod +x *
    #botmintod
    wget https://raw.githubusercontent.com/rizyulstore/xva/main/botmin.zip
    unzip botmin.zip
    mv adminbot /etc
