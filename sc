...
echo -e "       © Recode By Undera TUNNEL ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
...
VALIDITY () {
    ...
    echo -e "\e[31mTolong Renew Script di t.me/undersTunel\e[0m"
    exit 0
fi
}
...
echo -e "              Contact Admin : UNDERS"
echo -e "             ${green}Telegram t.me/undersTunel "
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
rm -f premi.sh
exit 0
...
rm -f /root/cf.sh
    CHATID="6425014714"
    KEY="6491411196:AAG7hWWkVnLefrKaHzh8YDG5FIxWqcdLuMU"
    TIME="10"
...
============================
(C) Copyright 2023 By UndersTunnel
============================
